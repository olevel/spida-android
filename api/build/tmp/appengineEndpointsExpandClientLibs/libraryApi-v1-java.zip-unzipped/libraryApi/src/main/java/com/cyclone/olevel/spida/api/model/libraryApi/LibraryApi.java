...
public class LibraryApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetLibrary extends LibraryApiRequest<com.cyclone.olevel.spida.api.model.libraryApi.model.Library> {
    ...
    protected GetLibrary(java.lang.Long id) {
      super(LibraryApi.this, "GET", REST_PATH, null, com.cyclone.olevel.spida.api.model.libraryApi.model.Library.class);
   ...
   *
   * @param content the {@link com.cyclone.olevel.spida.api.model.libraryApi.model.Library}
   * @return the request
   */
  public InsertLibrary insertLibrary(com.cyclone.olevel.spida.api.model.libraryApi.model.Library content) throws java.io.IOException {
    InsertLibrary result = new InsertLibrary(content);
    initialize(result);
    return result;
  }

  public class InsertLibrary extends LibraryApiRequest<com.cyclone.olevel.spida.api.model.libraryApi.model.Library> {
     ...
     * @since 1.13
     */
    protected InsertLibrary(com.cyclone.olevel.spida.api.model.libraryApi.model.Library content) {
      super(LibraryApi.this, "POST", REST_PATH, content, com.cyclone.olevel.spida.api.model.libraryApi.model.Library.class);
    }
