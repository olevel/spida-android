 ...
 * on 2016-03-26 at 11:32:45 UTC 
 * Modify at your own risk.
 */

package com.cyclone.olevel.spida.backend.model.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<com.cyclone.olevel.spida.backend.model.userApi.model.User> {

    private static final String REST_PATH = "user/{mId}";
    ...
    protected Get(java.lang.Long mId) {
      super(UserApi.this, "GET", REST_PATH, null, com.cyclone.olevel.spida.backend.model.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.cyclone.olevel.spida.backend.model.userApi.model.User}
   * @return the request
   */
  public Insert insert(com.cyclone.olevel.spida.backend.model.userApi.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<com.cyclone.olevel.spida.backend.model.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(com.cyclone.olevel.spida.backend.model.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.cyclone.olevel.spida.backend.model.userApi.model.User.class);
    }
  ...
  public class List extends UserApiRequest<com.cyclone.olevel.spida.backend.model.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.cyclone.olevel.spida.backend.model.userApi.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long mId, com.cyclone.olevel.spida.backend.model.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(mId, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.cyclone.olevel.spida.backend.model.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long mId, com.cyclone.olevel.spida.backend.model.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.cyclone.olevel.spida.backend.model.userApi.model.User.class);
      this.mId = com.google.api.client.util.Preconditions.checkNotNull(mId, "Required parameter mId must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long mId, com.cyclone.olevel.spida.backend.model.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(mId, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.cyclone.olevel.spida.backend.model.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long mId, com.cyclone.olevel.spida.backend.model.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.cyclone.olevel.spida.backend.model.userApi.model.User.class);
      this.mId = com.google.api.client.util.Preconditions.checkNotNull(mId, "Required parameter mId must be specified.");
    }
