 ...
 * on 2016-03-26 at 10:46:22 UTC 
 * Modify at your own risk.
 */

package com.cyclone.olevel.spida.backend.quoteApi;
...
public class QuoteApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends QuoteApiRequest<com.cyclone.olevel.spida.backend.quoteApi.model.Quote> {
    ...
    protected Get(java.lang.Long id) {
      super(QuoteApi.this, "GET", REST_PATH, null, com.cyclone.olevel.spida.backend.quoteApi.model.Quote.class);
   ...
   *
   * @param content the {@link com.cyclone.olevel.spida.backend.quoteApi.model.Quote}
   * @return the request
   */
  public Insert insert(com.cyclone.olevel.spida.backend.quoteApi.model.Quote content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends QuoteApiRequest<com.cyclone.olevel.spida.backend.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected Insert(com.cyclone.olevel.spida.backend.quoteApi.model.Quote content) {
      super(QuoteApi.this, "POST", REST_PATH, content, com.cyclone.olevel.spida.backend.quoteApi.model.Quote.class);
    }
  ...
  public class List extends QuoteApiRequest<com.cyclone.olevel.spida.backend.quoteApi.model.CollectionResponseQuote> {
     ...
     */
    protected List() {
      super(QuoteApi.this, "GET", REST_PATH, null, com.cyclone.olevel.spida.backend.quoteApi.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long id, com.cyclone.olevel.spida.backend.quoteApi.model.Quote content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends QuoteApiRequest<com.cyclone.olevel.spida.backend.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long id, com.cyclone.olevel.spida.backend.quoteApi.model.Quote content) {
      super(QuoteApi.this, "PATCH", REST_PATH, content, com.cyclone.olevel.spida.backend.quoteApi.model.Quote.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long id, com.cyclone.olevel.spida.backend.quoteApi.model.Quote content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends QuoteApiRequest<com.cyclone.olevel.spida.backend.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long id, com.cyclone.olevel.spida.backend.quoteApi.model.Quote content) {
      super(QuoteApi.this, "PUT", REST_PATH, content, com.cyclone.olevel.spida.backend.quoteApi.model.Quote.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
